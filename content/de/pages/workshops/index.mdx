...
<DownloadButton label="Workshop Programme" file="public/downloads/files/gwln-8-programme/file.pdf" />
...
<DownloadButton label="Workshop Programme" file="public/downloads/files/programme-constructicography-in-practice-constructions-challenges-and-opportunities/file.pdf" />

Weitere Information findet sich auf der dezidierten Website:

<LinkButton label="Workshop-Website" item={{"discriminant":"external","value":"https://www.germanistik.hhu.de/constructicography-in-practice"}} />
...
<LinkButton label="Workshop details and preliminary programme" item={{"discriminant":"external","value":"https://phraseo-mwe2026.sciencesconf.org/resource/page/id/9"}} />
